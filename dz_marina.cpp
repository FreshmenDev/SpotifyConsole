...
int main() {
	...
	const char* array_songs[TOTAL_NUMBER_OF_SONGS];
	const char* array_bands[TOTAL_NUMBER_OF_SONGS];
	int popularity_of_songs[TOTAL_NUMBER_OF_SONGS];


	const char* TopSongs[TOTAL_NUMBER_OF_SONGS];
	const char* TopBands[TOTAL_NUMBER_OF_SONGS];
	int popularity_of_top_songs[TOTAL_NUMBER_OF_SONGS];
